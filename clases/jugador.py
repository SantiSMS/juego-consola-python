...
class Jugador:
    def __init__(self, nombre):
        self.nombre = nombre
        self.salud = 100    # son atributos que no necesitamos que el constructor lo pase
        self.nivel = 1      # (es con lo que inicia el juego)
        self.experiencia = 0
    ...
    def ganar_experiencia(self, experiencia):
        ...
        if self.experiencia >= 100:
            self.nivel += 1
            self.experiencia = 0
            print(f"{self.nombre} has subido de nivel a {self.nivel}")
